...
const modules: MoreModule[] = [
  ...
  { id: 'financial-health-audit', title: 'Health Audit',    description: 'CFA/FRM audit — DSCR, DIR, Yield-Cost Spread',     icon: Activity,  status: 'available',    category: 'analysis',  priority: 'high',  roleBlocked: 'BROTHER' },
